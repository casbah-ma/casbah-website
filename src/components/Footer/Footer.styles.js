...
export const FooterWrapper = tw.footer`w-full h-[45.4rem] bg-deepBlue p-4 pt-6 flex flex-col justify-center items-center -z-20
                                        md:(h-[29.438rem] py-10)
                                        lg:(h-[37.5rem])`;

export const FooterContainer = tw.div`w-full p-0 flex flex-col md:flex-row justify-center items-center z-30`;

export const FooterCol = tw.div`flex flex-col self-start md:(-mr-[1px] self-end)`;
...
export const FooterLogo = tw.div`w-full h-[5.313rem] border border-solid border-white 
                                ...
                                md:(w-[14.75rem] h-[4.75rem] py-7 px-8 self-end)
                                lg:(w-[37.125rem] h-[6.75rem])`;
export const SocialWrapper = tw.div`w-fit h-fit flex flex-col md:self-end lg:(flex-row)`;
export const FooterSocial = tw.div`-mt-[1px] w-[95%] h-[4.688rem] font-made font-light 
                                    uppercase text-2xl text-white border  border-solid border-white 
                                    flex justify-center items-center
                                    md:(w-[17.438rem] h-[3.813rem] py-7 px-8 self-end)
                                    lg:(w-[12.313rem] h-[7.688rem] )`;

export const FooterSocialItems = tw.div`-mt-[1px] -ml-[1px] w-fit h-[4rem] sm:h-[4.688rem] font-made 
                                        font-light uppercase text-2xl text-white 
                                        border border-solid border-white flex flex-wrap 
                                        divide-x divide-white
                                        md:(h-[4.938rem] self-end)
                                        lg:(h-[7.688rem])`;
export const SocialItem = tw.div`xs:w-[3.88rem] sm:w-[5.4rem] lg:w-[7.688rem] h-full 
                                    flex justify-center items-center 
...
export const FooterNavigation = tw.div`w-full h-[18.063rem] border border-solid border-white text-white
                                        ...
                                        md:(w-[24rem] h-[21.188rem] gap-4) 
                                        lg:(w-[38.25rem] border-l-0  pl-[11.375rem] gap-6)`;

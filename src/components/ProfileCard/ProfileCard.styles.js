...
export const imagesSize = tw`w-full bg-deepBlue h-[20.125rem] 
                             md:( h-[20.125rem])
                             lg:( h-[25.188rem])`;

export const CardWrapper = tw.div`w-full flex flex-col justify-start items-start  gap-6 pb-6 border-b border-darkBlue cursor-pointer
                                   lg:max-w-[25.188rem] `;

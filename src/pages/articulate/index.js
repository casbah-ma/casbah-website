...
export const getStaticProps = ({ locale }) => {
  const data =
    allArticulates.find((page) => page.lang === locale) ||
    allArticulates.find((page) => page.lang === 'en') ||
    null;
  return {
    props: {
      data,
...
const metadata = {
  ...
  description:
    "Discover Casbah's strategic approach to digital transformation. We focus on aligning teams, resources, and operations with long-term goals, prioritizing end-user experience and effective digital frameworks.",
};
